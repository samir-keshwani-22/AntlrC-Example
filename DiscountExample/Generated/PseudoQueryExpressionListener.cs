...
public interface IPseudoQueryExpressionListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterLogical_operator([NotNull] PseudoQueryExpressionParser.Logical_operatorContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="PseudoQueryExpressionParser.logical_operator"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitLogical_operator([NotNull] PseudoQueryExpressionParser.Logical_operatorContext context);
}
